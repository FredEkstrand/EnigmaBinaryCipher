This project was created to extend the German WWII Enigma Cipher from encrypting text messages to binary files.
...
<br/>
[Enigma Binary Cipher API](http://fredekstrand.github.io/tree/master/html/EnigmaBinaryCipher)
<br/>
